...
/**
 * Interface for the controller that implements flexible stocks program, dollar cost averaging,
 * using GUI based view.
 */
public interface ControllerGUI extends Controller {
   ...
   * cost basis till a date,getting value of the portfolio on a specific date, retrieving the
   * composition of the portfolio,dollar cost averaging on the existing portfolio,
   ...
   * @throws FileNotFoundException if file is not found while validating the tickrs to portfolio
   */
  ...
  /**
   * Helps to validate the inmput fields and modify the existing portfolio by allowing the user to,
   ...
   * @param statuslabel      specifies that modification needs to occur and check input fields
   ...
   *
   * @param pfNameComposition is the name of the portfolio for which composition to be computed
   */
   ...
   * @param dollarexistpfname        portfolio name on which dollar-averaging strategy to be done
   * @param stocksexist              is the list of stocks given by the user, seperated by ','
   * @param weightsexist             is the list of weights given by the user, seperated by ','
   ...
   * @param stocksnew              is the list of stocks string given by the user, seperated ','
  ...
  /**
   * Displays the pane that lets the user set the root path for storing the portfolios that are
   * to be created modified or perform dollar averaging strategy.
   */
