...
public class PortfolioImplTest {
  ...
  public void checkIfDateInRightFormatCorrect() {
    ...
    assertTrue(portfolioObj.checkIfRightFormat("2022-02-01"));
  }

  @Test
  public void checkIfDateInRightFormatWrong1() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkIfRightFormat("01/02/2020"));
  }

  @Test
  public void checkIfDateInRightFormatWrong2() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkIfRightFormat("01022020"));
  }
  ...
  public void ifPortfolioNameRightFormatValid() {
    ...
    Portfolio portfolioObj = new PortfolioImpl();
    assertTrue(portfolioObj.checkValidpfName("healthPortfolio"));
  }
  ...
  public void ifPortfolioNameRightFormatInvalid1() {
    ...
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName("Health Portfolio"));
  }
  ...
  public void ifPortfolioNameRightFormatInvalidEmptyName() {
    // With any white spaces is invalid
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName(""));
  }
  ...
  public void ifPortfolioNameRightFormatInvalidNullName() {
    // With any white spaces is invalid
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName(null));
  }
  ...
  public void ifPortfolioNameRightFormatInvalidBigName() {
    ...
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName("abcdefghijklmnopqrstuvwxyz"));
  }
  ...
  public void ifPortfolioNameRightFormatInvalidSpecialCharacters() {
    ...
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName("ab*b"));
  }
  ...
  public void ifPortfolioNameRightFormatInvalidNumbers() {
    // Name greater than 25 letters not allowed
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkValidpfName("2345678"));
  }

  @Test
  public void checkDirectoryNameEndingValid() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertTrue(portfolioObj.checkLastEndingCharacter("/Users/"));
  }

  @Test
  public void checkDirectoryNameEndingInvalid() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkLastEndingCharacter("/Users"));
  }
  ...
  public void checkValidateTickrSymbolValid() {
    Portfolio portfolioObj = new PortfolioImpl();
    try {
      assertTrue(portfolioObj.validateTickrSymbol("AAL"));
  ...
  public void checkValidateTickrSymbolInvalid() {
    Portfolio portfolioObj = new PortfolioImpl();
    try {
      assertFalse(portfolioObj.validateTickrSymbol("YZ"));
    } catch (FileNotFoundException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public void checkTodayDateAndTimePastDate() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkTodayDateAndTime("2020-12-12"));
  }

  @Test
  public void checkTodayDateAndTimeFutureDate() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkTodayDateAndTime("2024-11-12"));
  }
  ...
  public void checkTodayDateAndTimeInvalidDateFormat2() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkTodayDateAndTime("20241112"));
  }

  @Test
  public void checkFutureDateForFutureDate() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertTrue(portfolioObj.checkFutureDate("2028-11-23"));
  }

  @Test
  public void checkFutureDateForPresentDate() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkFutureDate(String.valueOf(LocalDate.now())));
  }

  @Test
  public void checkFutureDateForPastDate() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkFutureDate("1998-06-01"));
  }

  @Test
  public void checkFutureDateForWrongFormat1() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkFutureDate("123435436"));
  }
  ...
  public void checkFutureDateForWrongFormat2() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkFutureDate("1234-35-436"));
  }

  @Test
  public void checkFutureDateForWrongFormat3() {
    Portfolio portfolioObj = new PortfolioImpl();
    assertFalse(portfolioObj.checkFutureDate("1234/11/11"));
  }
